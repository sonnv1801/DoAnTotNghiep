...
export const HomePageStaff = () => {
  return (
    ...
    <div className='w-full h-[500px] bg-gray-900/90 absolute '>
      <img className='w-full h-full object-cover mix-blend-overlay' src={BackImage} alt="/" />
    </div>
    
    <div className='w-full  text-white relative'>
        <div className='mb-28'>
            <h2 className='text-3xl pt-8 text-slate-300 uppercase text-center'>Xem Chấm Công</h2>
